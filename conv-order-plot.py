...
dx = [3.2e-2, 1.6e-2, 8e-3, 4e-3]

# Variable overlap and variable support radius
# Error of anayltical flux mapping from Edge to Core
l2_core = [4.097e-4, 1.476e-4, 4.980e-5, 2.282e-5]
linf_core = [8.771e-4, 2.770e-4, 1.148e-4, 4.967e-5]

# Error of analytical values mapping from Core to Edge
l2_edge = [3.674e-4, 6.176e-5, 2.476e-5, 1.195e-5]
linf_edge = [6.655e-4, 1.624e-4, 6.689e-5, 3.981e-5]
